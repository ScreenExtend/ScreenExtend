//! ASBD parse + PCM→interleaved-stereo-f32 conversion tests (PRD §5.4, §10). Mirrors the Windows
//! `windows_utils/audio/test/format.rs` intent, adapted to the macOS ASBD / planar layout.
