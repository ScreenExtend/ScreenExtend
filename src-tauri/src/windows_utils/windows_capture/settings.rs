...
use super::graphics_capture_picker::HwndGuard;
...
/// - [`super::graphics_capture_picker::HwndGuard`] for unknown HWND-based sources.
pub enum GraphicsCaptureItemType {
    ...
    /// [`super::graphics_capture_picker::HwndGuard`].
