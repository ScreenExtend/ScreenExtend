...
//!
//! To acquire a [`super::GraphicsCaptureItem`] for a monitor, use the implementation of
//! [`super::settings::TryIntoCaptureItemWithDetails`] for [`Monitor`].
use std::mem;
...
/// ```
///
/// See also: [`super::settings::TryIntoCaptureItemWithDetails`].
